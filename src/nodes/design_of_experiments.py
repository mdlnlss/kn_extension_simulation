...
This node combines one or more factor definition tables produced by the Factor Definition node and applies the selected experimental design strategy to generate all configurations to be simulated. Results are provided in both wide and long format for flexible downstream use.
